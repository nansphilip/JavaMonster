...
public interface Contaminant {
    ...
    default void contaminer(Creature creatureMourrante, Salle salle){
        ...
        HashSet<Maladie> maladies = creatureMourrante.getMaladies();
        ...
        logger.info("La créature {} vient d'être contaminée par la maladie {}.", creature.getNomComplet(), maladie.getNom());
    }
} 
